    ...
    return (
        <>
            <section className="" id="contact">
                <img className="w-full h-96 object-cover mx-auto" src="https://c.wallhere.com/photos/6a/a7/photography_phone_box_depth_of_field_phone-78038.jpg!d" alt="imagen portada ipv tucuman instituto provincial de vivienda" />
